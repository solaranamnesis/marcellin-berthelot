...
_Transcrit sur_ M, f. 92 v. --- _Collationné_ (le § 1, seul existant) _sur_ M, f. 115 r. (= M²) ;--- _sur_ A, f. 85 r. ;--- _sur_ K, f. 1 r. ;--- _sur_ Lc, page 265. --- _Nous noterons ici, une fois pour toutes, que les leçons de_ M _différentes de celles de_ A K _ont été reproduites, dans le manuscrit_ K, _soit en marge, soit sur la ligne par une main élégante_ (Kmg.), _contemporaine du ms. Il en est de même des leçons de_ M. _omises dans le texte de_ A K.
